...
export default function UserPage() {
  ...
  return (
    <div className="bg-linear-to-r from-primary to-secondary w-screen h-screen flex gap-4 p-17">
      <div className="max-w-7xl mx-auto bg-gray-300/40 backdrop-blur-2xl border-gray-100 rounded-2xl flex flex-col gap-9 p-7 items-start w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 w-full">
          <div className="border-2 rounded-4xl overflow-clip px-5 py-2 hover:bg-gray-300/40 backdrop-blur-2xl border-gray-100">
          ...
          {data?.playlists.map((playlist, index) => (
            <div
              className="border-2 rounded-4xl overflow-clip px-5 py-2 hover:bg-gray-300/40 backdrop-blur-2xl border-gray-100"
              key={index}
            >
              <Link
                to={""}
